...
impl Settings {
    ...
    pub fn write_default_config(path: &str) -> Result<()> {
        ...
        toml_string.push_str("\n# [gcp]\n");
        toml_string.push_str("# service_account = \"${GCS_SERVICE_ACCOUNT}\"  # Path to service account JSON file\n");
        toml_string.push_str("# Or use application_credentials = \"${GOOGLE_APPLICATION_CREDENTIALS}\"\n");
