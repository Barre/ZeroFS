...
- The gRPC-web endpoint exposes the complete `AdminService`: `CreateCheckpoint`, `ListCheckpoints`, `DeleteCheckpoint`, `GetCheckpointInfo`, `WatchFileAccess`, `Flush`, and `StreamStats` — including methods the UI itself never calls.
