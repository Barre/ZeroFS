export const metadata = {
  title: 'Telemetry',
  description:
    'What anonymous usage data ZeroFS collects, where it is sent, and how to disable it.',
}

# Telemetry

ZeroFS collects anonymous usage data. This page lists what is collected, how it is sent, and how to disable it. {{ className: 'lead' }}
