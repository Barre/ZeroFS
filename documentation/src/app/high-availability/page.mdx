...
| Abandoned handoff observation | 5 s unchanged |
...
`force_recovery` bypasses normal stale-handoff observation. It is a break-glass assertion that every former participant is dead:
