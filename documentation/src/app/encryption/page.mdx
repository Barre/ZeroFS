...
File data and metadata take separate paths to the object store. Both are compressed then encrypted; only metadata passes through SlateDB.
...
graph TB
    ...
    SEGBUF -->|immutable segment objects| S3
    BT -->|SST blocks| S3
