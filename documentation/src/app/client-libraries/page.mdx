...
Errors surface as a single, exhaustive `ZeroFsError`. It is intentionally exhaustive: a new server-side variant fails the binding's build rather than silently degrading. Each language matches it idiomatically:
