...
2. Segment garbage collection, every 60 seconds, deletes segments with no live bytes and repacks fragmented ones (live data below 50%, or segments under 1 MiB)
3. Freed segments come off the bill
