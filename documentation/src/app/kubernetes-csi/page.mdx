...
[`networkpolicy-example.yaml`](https://github.com/Barre/ZeroFS/blob/main/zerofs/zerofs-csi/deploy/networkpolicy-example.yaml) ships in the deploy bundle and enforces both. Apply it alongside the gateway (adapt the labels to your manifests):
