...
# Error: Failed to parse config file: zerofs.toml: TOML parse error ...
#        invalid type: string "50GB", expected f64
# Solution: Use a bare number for GB in config
...
# disk_size_gb = 50             # Also correct: integers parse as floats

# Wrong format:
# disk_size_gb = "50GB"         # No quotes, no unit
```
