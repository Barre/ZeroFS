...
export const metadata = {
  title: 'Architecture',
  description:
    'How ZeroFS is layered: NFS, 9P, and NBD servers over a shared filesystem core, with file data in immutable segment objects on S3 and metadata in an LSM tree. Covers protocol choice and filesystem limits.',
}
