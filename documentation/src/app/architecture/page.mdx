...
| [Native kernel client](/kernel-client) | DKMS-built `zerofs` module; speaks private 9P directly through VFS and netfslib | Fast Linux mounts with reconnect and HA failover |
