...
### macOS
```bash
mount -t nfs -o sync,nolocks,vers=3,tcp,port=2049,mountport=2049,hard 127.0.0.1:/ mnt
```

### Linux
```bash
mount -t nfs -o sync,nolock,vers=3,tcp,port=2049,mountport=2049,hard 127.0.0.1:/ /mnt
```
